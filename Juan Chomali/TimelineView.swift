...
public class TimelineView: UIView {
	...
	*/
    ...
    private func bulletView(size: CGSize, bulletType: BulletType) -> UIView {
        ...
        shapeLayer.strokeColor = UIColor(red: 42.0/255.0, green: 128.0/255.0, blue: 185.0/255.0, alpha: 1).CGColor
	...
	private func blockForTimeFrame(element: TimeFrame, imageTag: Int) -> UIView{
		...
		if let image = element.image{
			...
			v.addConstraints([
				...
				NSLayoutConstraint(item: backgroundViewForImage, attribute: .Top, relatedBy: .Equal, toItem: v, attribute: .Top, multiplier: 1.0, constant: 30)
				])
			...
			v.addConstraints([
				...
				NSLayoutConstraint(item: button, attribute: .Top, relatedBy: .Equal, toItem: v, attribute: .Top, multiplier: 1.0, constant: 30)
				])
		}
		...
		v.addConstraints([
			...
			NSLayoutConstraint(item: textLabel, attribute: .Top, relatedBy: .Equal, toItem: titleLabel, attribute: .Bottom, multiplier: 1.0, constant: y),
